...
const Header = () => {
  ...
  window.addEventListener("scroll", function () {
    ...
    // when the scroll ins higher than 200 viewport heingh, add the scroll-header class to a tag with the header tag
  ...
  return (
    <header className="header">
      <nav className="nav container">
        <a href="index.html" className="nav__logo">Juan Diaz</a>
